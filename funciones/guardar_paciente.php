...
$stmt = $conexion->prepare("
  ...
  VALUES (?,?,?,?,?,?,?,?,?,?,?)
");
$edad = null; // si no la calculas aún
$stmt->bind_param(
  'ssissssssss',
  $nombre, $fecha_nacimiento, $edad, $celular, $estado_civil, $nacionalidad, $domicilio,
  $profesion, $contacto_emergencia, $telefono_emergencia, $estado_registro
...
// 2) Insertar HISTORIA CLÍNICA (autorreporte)
$sql = "
...
$stmt2->bind_param(
  ...
  $id_paciente, $lugar, $fecha, $motivo_consulta,
  $enf_general, $enf_cual, $medicamentos, $alergias, $transfusiones, $operado, $operado_deque, $operado_cuando,
  $fuma, $toma, $drogas,
  $diabetes,$hipertension,$epilepsia,$infarto,$anemia,$asma,$hepatitis,$tiroides,$angina_pecho,$tuberculosis,
  $renal,$venereas,$vih,$gastritis,$embarazo,$covid,$cancer,$otros,
  $observaciones,$firma_paciente
);

// Mapear POST → variables
$lugar = field('lugar');
$fecha = field('fecha');
...
// Redirigir a “gracias” o directo al panel
