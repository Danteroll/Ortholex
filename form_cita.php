...
// Prepara los eventos del calendario
$citas = [];
...
<body>
    ...
    <div class="inventario-container">
      ...
      <div class="tabla-inventario">
        <table>
          ...
          <?php else: ?>
            <tr>
              <td colspan="6" style="text-align:center;padding:20px;color:#555;">No hay citas registradas.</td>
            </tr>
          <?php endif; ?>
        </table>
      </div>
  ...
  <script>
    ...
    function cerrarFormEliminar() {
      ocultar('formEliminar');
    }

    function mostrar(id) {
      ['nuevaCita', 'formEditar', 'formEliminar'].forEach(f => ocultar(f));
